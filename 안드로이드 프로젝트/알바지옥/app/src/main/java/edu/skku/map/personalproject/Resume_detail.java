...
public class Resume_detail extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Intent myresume_intent = getIntent();
        username = myresume_intent.getStringExtra("Username");
        store_name = myresume_intent.getStringExtra("Store");
        ...
        mPostReference.child("Resume").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for(DataSnapshot postSnapshot : dataSnapshot.getChildren()){
                    ...
                    if(get.store_name.equals(store_name) && get.username.equals(username)){
